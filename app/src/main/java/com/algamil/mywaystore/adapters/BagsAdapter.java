...
public class BagsAdapter extends RecyclerView.Adapter < BagsAdapter.BagsCustomRecyclerViewHolder > {

    Activity activity;
    List < BagsData > list;


    public BagsAdapter ( List < BagsData > list , Activity activity ) {
        this.list = list;
    ...
    {
        getApiClient().delete ( id ).enqueue ( new Callback < Bags > ( ) {
            @Override
